...
<html>
	...
	<body id="top">
			...
			-->
				<section id="banner" data-video="banner">
					<div class="inner">
						<header>
				...
				<div id="main">
					...
					<!-- Boxes -->
						...
						<div class="thumbnails">
							...
							$marcas = $client->getMarca();
                            foreach ($marcas as $marca => $url) {
								?>
								<div class="box">
									<a href="<?= $url ?>" class="image fit" title="ver video"><img src="<?= strtolower($marca) ?>.png" alt="logo <?= $marca ?>" /></a>
									<div class="inner">
									   <h3><a href="data.php?marca=<?= $marca ?>" data-poptrox="ajax,600x400">Modelos <?= $marca ?></a></h3>
